  ...
  function initLoginForm() {
      ...
      form.addEventListener(
          ...
          (event) => {
              ...
              showFormStatus(
                  form,
                  "Datos válidos. Entrando a tu espacio de aprendizaje…",
                  "success"
              );

              window.dispatchEvent(
                  new CustomEvent("aulago:login-success")
              );
  ...
  function initRegisterForm() {
      ...
      form.addEventListener(
          ...
          (event) => {
              ...
              showFormStatus(
                  form,
                  `Formulario válido para registro como ${selectedRole || "usuario"}. Ya puedes continuar al acceso.`,
                  "success"
              );

              window.dispatchEvent(
                  new CustomEvent("aulago:register-success")
              );
